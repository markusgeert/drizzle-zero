...
describe("getGeneratedSchema", () => {
  ...
  it("should generate schema from drizzle schema source file", async () => {
    ...
    expect(generatedSchema).toContain('import type * as DrizzleZeroTypes from "./mock-drizzle-schema";');
    expect(generatedSchema).toContain('import type { DrizzleToZeroSchema } from "drizzle-zero";');
    ...
    expect(customTypeGenerated).toContain(
      '"customType": null as DrizzleToZeroSchema<typeof DrizzleZeroTypes>["tables"]["users"]["columns"]["customField"]["customType"]'
    );
  ...
  it("should handle different directory structures for import paths", async () => {
    ...
    try {
      ...
      expect(generatedSchema).toContain('import type * as DrizzleZeroTypes from "../nested/deep/structure/drizzle-schema";');
    } finally {
